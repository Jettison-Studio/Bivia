...
type BackendQuiz = { id: string; title: string; description: string; category_id: string; publish_at: string; updated_at?: string; status: string; questions: BackendQuestion[] };
...
export async function loadContent(): Promise<{ quizzes: EditorialQuiz[]; categories: EditorialCategory[] }> {
